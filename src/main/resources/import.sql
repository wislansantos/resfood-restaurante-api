...
INSERT INTO restaurante (nome, taxa_frete, cozinha_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, endereco_cidade_id) VALUES ('Restaurante D', 40, 2, 'exemplo de cep', 'exemplo de logradouro', 'exemplo de numero', 'exemplo de complemento', 'exemplo de bairro', 2);
